...
import net.ironedge.goatowl.client.renderer.NoroArmorRenderer;

import java.util.function.Consumer;
import java.util.List;

public class NoroItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public NoroItem(ArmorItem.Type type, Item.Properties properties) {
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new NoroArmorRenderer();
