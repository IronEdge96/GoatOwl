...
import net.ironedge.goatowl.RizeRinkakuThreeAnimation;
...
public class Modelrizerinkakuthree<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("goatowl", "modelrizerinkakuthree"), "main");
	public final ModelPart root;
	public final ModelPart Head;
	public final ModelPart Body;
	public final ModelPart Tails;
	public final ModelPart Tail1;
	public final ModelPart TopTailSegment;
	public final ModelPart TopTailSegment2;
	public final ModelPart TopTailSegment3;
	public final ModelPart TopTailSegment4;
	public final ModelPart TopTailSegment5;
	public final ModelPart TopTailSegment6;
	public final ModelPart TopTailSegment7;
	public final ModelPart TopTailSegment8;
	public final ModelPart TopTailSegment9;
	public final ModelPart TopTailSegment10;
	public final ModelPart TopTailSegment11;
	...
	public Modelrizerinkakuthree(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TopTailSegment10 = TopTailSegment9.addOrReplaceChild("TopTailSegment10",
				...
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition TopTailSegment11 = TopTailSegment10.addOrReplaceChild("TopTailSegment11", CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 0.0F, 4.5F));
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		if (pEntity instanceof AnimationInterface animationInterface) {
			this.animate(animationInterface.getRizeIdleThreeAnimationState(), RizeRinkakuThreeAnimation.RizeIdleThree, pAgeInTicks);
		}
	}
