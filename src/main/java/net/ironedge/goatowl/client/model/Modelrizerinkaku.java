...
import net.ironedge.goatowl.RizeRinkakuAnimation;
...
public class Modelrizerinkaku<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("goatowl", "modelrizerinkaku"), "main");
	...
	public Modelrizerinkaku(ModelPart root) {
		this.root = root;
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		if (pEntity instanceof AnimationInterface animationInterface) {
			this.animate(animationInterface.getRizeIdleFourAnimationState(), RizeRinkakuAnimation.RizeIdleFour, pAgeInTicks);
		}
	}
