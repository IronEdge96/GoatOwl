...
public class Modelshirorinkaku<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("goatowl", "modelshirorinkaku"), "main");
	...
	public final ModelPart LeftTailSegment10;
	public final ModelPart LeftTailSegment11;
