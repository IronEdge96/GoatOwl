...
public class Modelkanekirinkakutestalt<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("goatowl", "modelkanekirinkakutestalt"), "main");
	...
	public final ModelPart TopTailSegmentA;
	public final ModelPart TopTailSegmentB;
	public final ModelPart TopTailSegmentC;
	public final ModelPart TopTailSegmentD;
	public final ModelPart TopTailSegmentE;
	public final ModelPart TopTailSegmentF;
	public final ModelPart TopTailSegmentG;
	public final ModelPart TopTailSegmentH;
	public final ModelPart TopTailSegmentI;
	public final ModelPart TopTailSegmentJ;
	public final ModelPart TopTailSegmentK;
	public final ModelPart TailB;
	public final ModelPart MiddleTailSegmentA;
	public final ModelPart MiddleTailSegmentB;
	public final ModelPart MiddleTailSegmentC;
	public final ModelPart MiddleTailSegmentD;
	public final ModelPart MiddleTailSegmentE;
	public final ModelPart MiddleTailSegmentF;
	public final ModelPart MiddleTailSegmentG;
	public final ModelPart MiddleTailSegmentH;
	public final ModelPart MiddleTailSegmentI;
	public final ModelPart MiddleTailSegmentJ;
	public final ModelPart MiddleTailSegmentK;
	public final ModelPart TailC;
	public final ModelPart BottomTailSegmentA;
	public final ModelPart BottomTailSegmentB;
	public final ModelPart BottomTailSegmentC;
	public final ModelPart BottomTailSegmentD;
	public final ModelPart BottomTailSegmentE;
	public final ModelPart BottomTailSegmentF;
	public final ModelPart BottomTailSegmentG;
	public final ModelPart BottomTailSegmentH;
	public final ModelPart BottomTailSegmentI;
	public final ModelPart BottomTailSegmentJ;
	public final ModelPart BottomTailSegmentK;
