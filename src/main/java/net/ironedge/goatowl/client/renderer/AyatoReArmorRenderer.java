...
import net.ironedge.goatowl.item.model.AyatoReModel;
import net.ironedge.goatowl.item.AyatoReItem;

public class AyatoReArmorRenderer extends GeoArmorRenderer<AyatoReItem> {
	public AyatoReArmorRenderer() {
		super(new AyatoReModel());
	...
	@Override
	public RenderType getRenderType(AyatoReItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
