...
import net.ironedge.goatowl.item.model.NoroModel;
import net.ironedge.goatowl.item.NoroItem;

public class NoroArmorRenderer extends GeoArmorRenderer<NoroItem> {
	public NoroArmorRenderer() {
		super(new NoroModel());
	...
	@Override
	public RenderType getRenderType(NoroItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
