...
import net.ironedge.goatowl.item.model.VsArimaKanekiModel;
import net.ironedge.goatowl.item.VsArimaKanekiItem;

public class VsArimaKanekiArmorRenderer extends GeoArmorRenderer<VsArimaKanekiItem> {
	public VsArimaKanekiArmorRenderer() {
		super(new VsArimaKanekiModel());
	...
	@Override
	public RenderType getRenderType(VsArimaKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
