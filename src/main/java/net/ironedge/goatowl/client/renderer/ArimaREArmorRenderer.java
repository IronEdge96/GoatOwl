...
import net.ironedge.goatowl.item.model.ArimaREModel;
import net.ironedge.goatowl.item.ArimaREItem;

public class ArimaREArmorRenderer extends GeoArmorRenderer<ArimaREItem> {
	public ArimaREArmorRenderer() {
		super(new ArimaREModel());
	...
	@Override
	public RenderType getRenderType(ArimaREItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
