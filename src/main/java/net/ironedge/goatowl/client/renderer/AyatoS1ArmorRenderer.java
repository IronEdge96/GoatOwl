...
import net.ironedge.goatowl.item.model.AyatoS1Model;
import net.ironedge.goatowl.item.AyatoS1Item;

public class AyatoS1ArmorRenderer extends GeoArmorRenderer<AyatoS1Item> {
	public AyatoS1ArmorRenderer() {
		super(new AyatoS1Model());
	...
	@Override
	public RenderType getRenderType(AyatoS1Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
