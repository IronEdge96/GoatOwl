...
import net.ironedge.goatowl.item.model.CentipedeKanekiModel;
import net.ironedge.goatowl.item.CentipedeKanekiItem;

public class CentipedeKanekiArmorRenderer extends GeoArmorRenderer<CentipedeKanekiItem> {
	public CentipedeKanekiArmorRenderer() {
		super(new CentipedeKanekiModel());
	...
	@Override
	public RenderType getRenderType(CentipedeKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
