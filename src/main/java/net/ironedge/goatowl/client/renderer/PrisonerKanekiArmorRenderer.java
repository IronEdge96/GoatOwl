...
import net.ironedge.goatowl.item.model.PrisonerKanekiModel;
import net.ironedge.goatowl.item.PrisonerKanekiItem;

public class PrisonerKanekiArmorRenderer extends GeoArmorRenderer<PrisonerKanekiItem> {
	public PrisonerKanekiArmorRenderer() {
		super(new PrisonerKanekiModel());
	...
	@Override
	public RenderType getRenderType(PrisonerKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
