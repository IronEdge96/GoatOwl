...
import net.ironedge.goatowl.item.model.ArimaOEKOutfitModel;
import net.ironedge.goatowl.item.ArimaOEKOutfitItem;

public class ArimaOEKOutfitArmorRenderer extends GeoArmorRenderer<ArimaOEKOutfitItem> {
	public ArimaOEKOutfitArmorRenderer() {
		super(new ArimaOEKOutfitModel());
	...
	@Override
	public RenderType getRenderType(ArimaOEKOutfitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
