...
import net.ironedge.goatowl.item.model.AltKanekiModel;
import net.ironedge.goatowl.item.AltKanekiItem;

public class AltKanekiArmorRenderer extends GeoArmorRenderer<AltKanekiItem> {
	public AltKanekiArmorRenderer() {
		super(new AltKanekiModel());
	...
	@Override
	public RenderType getRenderType(AltKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
