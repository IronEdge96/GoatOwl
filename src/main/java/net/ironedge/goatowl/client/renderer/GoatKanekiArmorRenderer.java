...
import net.ironedge.goatowl.item.model.GoatKanekiModel;
import net.ironedge.goatowl.item.GoatKanekiItem;

public class GoatKanekiArmorRenderer extends GeoArmorRenderer<GoatKanekiItem> {
	public GoatKanekiArmorRenderer() {
		super(new GoatKanekiModel());
	...
	@Override
	public RenderType getRenderType(GoatKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
