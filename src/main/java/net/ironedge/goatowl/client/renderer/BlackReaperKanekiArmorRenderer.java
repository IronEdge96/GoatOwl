...
import net.ironedge.goatowl.item.model.BlackReaperKanekiModel;
import net.ironedge.goatowl.item.BlackReaperKanekiItem;

public class BlackReaperKanekiArmorRenderer extends GeoArmorRenderer<BlackReaperKanekiItem> {
	public BlackReaperKanekiArmorRenderer() {
		super(new BlackReaperKanekiModel());
	...
	@Override
	public RenderType getRenderType(BlackReaperKanekiItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
