...
import net.ironedge.goatowl.item.model.NoroBlackModel;
import net.ironedge.goatowl.item.NoroBlackItem;

public class NoroBlackArmorRenderer extends GeoArmorRenderer<NoroBlackItem> {
	public NoroBlackArmorRenderer() {
		super(new NoroBlackModel());
	...
	@Override
	public RenderType getRenderType(NoroBlackItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
