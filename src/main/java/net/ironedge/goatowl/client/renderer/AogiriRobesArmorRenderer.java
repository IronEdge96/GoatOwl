...
import net.ironedge.goatowl.item.model.AogiriRobesModel;
import net.ironedge.goatowl.item.AogiriRobesItem;

public class AogiriRobesArmorRenderer extends GeoArmorRenderer<AogiriRobesItem> {
	public AogiriRobesArmorRenderer() {
		super(new AogiriRobesModel());
	...
	@Override
	public RenderType getRenderType(AogiriRobesItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
