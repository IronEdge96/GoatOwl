...
public class KanekiFormSelectGUIScreen extends AbstractContainerScreen<KanekiFormSelectGUIMenu> {
	...
	public void init() {
		super.init();
		imagebutton_rizerinkakuform4 = new ImageButton(this.leftPos + 69, this.topPos + -2, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_rizerinkakuform4.png"), 32, 64, e -> {
			if (true) {
				GoatowlMod.PACKET_HANDLER.sendToServer(new KanekiFormSelectGUIButtonMessage(0, x, y, z));
				KanekiFormSelectGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_rizerinkakuform6 = new ImageButton(this.leftPos + 69, this.topPos + 133, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_rizerinkakuform6.png"), 32, 64, e -> {
			if (true) {
		...
		imagebutton_kanekirinkaku3 = new ImageButton(this.leftPos + 141, this.topPos + 70, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_kanekirinkaku3.png"), 32, 64, e -> {
			if (true) {
		...
		imagebutton_kanekirinkaku8 = new ImageButton(this.leftPos + 6, this.topPos + 70, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_kanekirinkaku8.png"), 32, 64, e -> {
			if (true) {
		...
		imagebutton_kanekirinkakuclaw = new ImageButton(this.leftPos + 141, this.topPos + 7, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_kanekirinkakuclaw.png"), 32, 64, e -> {
			if (true) {
		...
		imagebutton_kanekirinkakublade = new ImageButton(this.leftPos + 6, this.topPos + 7, 32, 32, 0, 0, 32, new ResourceLocation("goatowl:textures/screens/atlas/imagebutton_kanekirinkakublade.png"), 32, 64, e -> {
			if (true) {
