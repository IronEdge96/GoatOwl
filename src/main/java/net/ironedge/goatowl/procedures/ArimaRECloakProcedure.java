...
public class ArimaRECloakProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof Player) {
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == GoatowlModItems.ARIMA_RE_CHESTPLATE.get()) {
				if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
					ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
					if (ResourceLocation.tryParse("goatowl:textures/entities/arimaoutfitrecloak.png") != null) {
						_texture = new ResourceLocation("goatowl:textures/entities/arimaoutfitrecloak.png");
					}
					Modelarimaoutfitrecloak newModel = new Modelarimaoutfitrecloak(context.bakeLayer(Modelarimaoutfitrecloak.LAYER_LOCATION));
