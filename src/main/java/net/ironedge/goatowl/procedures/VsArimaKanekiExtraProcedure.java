...
public class VsArimaKanekiExtraProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof Player) {
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == GoatowlModItems.VS_ARIMA_KANEKI_CHESTPLATE.get()) {
				if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
					ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
					if (ResourceLocation.tryParse("goatowl:textures/entities/blackreaperoutfitcloak.png") != null) {
						_texture = new ResourceLocation("goatowl:textures/entities/blackreaperoutfitcloak.png");
					}
					Modelblackreaperoutfitcloak newModel = new Modelblackreaperoutfitcloak(context.bakeLayer(Modelblackreaperoutfitcloak.LAYER_LOCATION));
			...
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == GoatowlModItems.VS_ARIMA_KANEKI_BOOTS.get()) {
				if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
					ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
					if (ResourceLocation.tryParse("goatowl:textures/entities/vsarimaonsie.png") != null) {
						_texture = new ResourceLocation("goatowl:textures/entities/vsarimaonsie.png");
					}
					Modelvsarimaonsie newModel = new Modelvsarimaonsie(context.bakeLayer(Modelvsarimaonsie.LAYER_LOCATION));
					newModel.LeftLeg.copyFrom(_pr.getModel().leftLeg);
					newModel.RightLeg.copyFrom(_pr.getModel().rightLeg);
					newModel.LeftArm.copyFrom(_pr.getModel().leftArm);
					newModel.RightArm.copyFrom(_pr.getModel().rightArm);
