...
public class AogiriRobesCloakProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == GoatowlModItems.AOGIRI_ROBES_CHESTPLATE.get()) {
			if (entity instanceof Player) {
				if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
					ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
					if (ResourceLocation.tryParse("goatowl:textures/entities/aogirirobescloak.png") != null) {
						_texture = new ResourceLocation("goatowl:textures/entities/aogirirobescloak.png");
					}
					Modelaogirirobescloak newModel = new Modelaogirirobescloak(context.bakeLayer(Modelaogirirobescloak.LAYER_LOCATION));
				...
				if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
					ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
					if (ResourceLocation.tryParse("goatowl:textures/entities/aogirirobeshood.png") != null) {
						_texture = new ResourceLocation("goatowl:textures/entities/aogirirobeshood.png");
					}
					Modelaogirirobeshood newModel = new Modelaogirirobeshood(context.bakeLayer(Modelaogirirobeshood.LAYER_LOCATION));
					newModel.LeftLeg.copyFrom(_pr.getModel().leftLeg);
					newModel.RightLeg.copyFrom(_pr.getModel().rightLeg);
					newModel.LeftArm.copyFrom(_pr.getModel().leftArm);
					newModel.RightArm.copyFrom(_pr.getModel().rightArm);
