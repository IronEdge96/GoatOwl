...
public class Modelkanekirinkakueight<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "kanekirinkakueight"), "main");
	...
	private final ModelPart RightTopTailSegment12;
	private final ModelPart RightTopTailSegment13;
	private final ModelPart RightTopTailSegment14;
	private final ModelPart RightTopTailSegment15;
	private final ModelPart RightTopTailSegment16;
	private final ModelPart RightTopTailSegment17;
	private final ModelPart RightTopTailSegment18;
	private final ModelPart RightTopTailSegment19;
	private final ModelPart RightTopTailSegment20;
	private final ModelPart RightTopTailSegment21;
	private final ModelPart RightTopTailSegment22;
	private final ModelPart Tail6;
	private final ModelPart LeftTopTailSegment12;
	private final ModelPart LeftTopTailSegment13;
	private final ModelPart LeftTopTailSegment14;
	private final ModelPart LeftTopTailSegment15;
	private final ModelPart LeftTopTailSegment16;
	private final ModelPart LeftTopTailSegment17;
	private final ModelPart LeftTopTailSegment18;
	private final ModelPart LeftTopTailSegment19;
	private final ModelPart LeftTopTailSegment20;
	private final ModelPart LeftTopTailSegment21;
	private final ModelPart LeftTopTailSegment22;
	private final ModelPart Tail7;
	private final ModelPart RightBottomTailSegment12;
	private final ModelPart RightBottomTailSegment13;
	private final ModelPart RightBottomTailSegment14;
	private final ModelPart RightBottomTailSegment15;
	private final ModelPart RightBottomTailSegment16;
	private final ModelPart RightBottomTailSegment17;
	private final ModelPart RightBottomTailSegment18;
	private final ModelPart RightBottomTailSegment19;
	private final ModelPart RightBottomTailSegment20;
	private final ModelPart RightBottomTailSegment21;
	private final ModelPart RightBottomTailSegment22;
	private final ModelPart Tail8;
	private final ModelPart LeftBottomTailSegment12;
	private final ModelPart LeftBottomTailSegment13;
	private final ModelPart LeftBottomTailSegment14;
	private final ModelPart LeftBottomTailSegment15;
	private final ModelPart LeftBottomTailSegment16;
	private final ModelPart LeftBottomTailSegment17;
	private final ModelPart LeftBottomTailSegment18;
	private final ModelPart LeftBottomTailSegment19;
	private final ModelPart LeftBottomTailSegment20;
	private final ModelPart LeftBottomTailSegment21;
	private final ModelPart LeftBottomTailSegment22;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Tail1 = Tails.addOrReplaceChild("Tail1", CubeListBuilder.create(),
				PartPose.offset(-1.45F, 0.3087F, 0.1863F));

		PartDefinition RightTopTailSegment = Tail1.addOrReplaceChild("RightTopTailSegment", CubeListBuilder.create(),
				PartPose.offset(-0.075F, 0.0F, 0.0F));

		PartDefinition RightTopTailSegment2 = RightTopTailSegment.addOrReplaceChild("RightTopTailSegment2",
				CubeListBuilder.create().texOffs(130, 93)
						.addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.25F)).texOffs(116, 31)
						.addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTopTailSegment3 = RightTopTailSegment2.addOrReplaceChild("RightTopTailSegment3",
				CubeListBuilder.create().texOffs(100, 0)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(101, 122)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTopTailSegment4 = RightTopTailSegment3.addOrReplaceChild("RightTopTailSegment4",
				CubeListBuilder.create().texOffs(40, 70)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(16, 114)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTopTailSegment5 = RightTopTailSegment4.addOrReplaceChild("RightTopTailSegment5",
				CubeListBuilder.create().texOffs(33, 112)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(2, 70)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightTopTailSegment6 = RightTopTailSegment5.addOrReplaceChild("RightTopTailSegment6",
				CubeListBuilder.create().texOffs(93, 75)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(24, 51)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightTopTailSegment7 = RightTopTailSegment6.addOrReplaceChild("RightTopTailSegment7",
				CubeListBuilder.create().texOffs(36, 91)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(45, 50)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTopTailSegment8 = RightTopTailSegment7.addOrReplaceChild("RightTopTailSegment8",
				CubeListBuilder.create().texOffs(3, 50)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(2, 91)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightTopTailSegment9 = RightTopTailSegment8.addOrReplaceChild("RightTopTailSegment9",
				CubeListBuilder.create().texOffs(35, 102)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(13, 125)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTopTailSegment10 = RightTopTailSegment9.addOrReplaceChild("RightTopTailSegment10",
				CubeListBuilder.create().texOffs(126, 111)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(102, 133)
						.mirror().addBox(-0.5F, -1.0F, -0.4F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightTopTailSegment11 = RightTopTailSegment10.addOrReplaceChild("RightTopTailSegment11",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r1 = RightTopTailSegment11.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.2854F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r2 = RightTopTailSegment11.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.2706F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r3 = RightTopTailSegment11.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.2706F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r4 = RightTopTailSegment11.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.2853F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r5 = RightTopTailSegment11.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.2853F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r6 = RightTopTailSegment11.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.2854F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r7 = RightTopTailSegment11.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.537F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition cube_r8 = RightTopTailSegment11.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.537F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition Tail2 = Tails.addOrReplaceChild("Tail2", CubeListBuilder.create(),
				PartPose.offset(1.45F, 0.3087F, 0.1863F));

		PartDefinition LeftTopTailSegment = Tail2.addOrReplaceChild("LeftTopTailSegment", CubeListBuilder.create(),
				PartPose.offset(0.075F, 0.0F, 0.0F));

		PartDefinition LeftTopTailSegment2 = LeftTopTailSegment.addOrReplaceChild("LeftTopTailSegment2",
				CubeListBuilder.create().texOffs(130, 93).mirror()
						.addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.25F)).mirror(false)
						.texOffs(116, 31).mirror()
						.addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-0.025F, 0.0F, 0.0F));
		...
		PartDefinition LeftTopTailSegment3 = LeftTopTailSegment2.addOrReplaceChild("LeftTopTailSegment3",
				CubeListBuilder.create().texOffs(100, 0).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(101, 122).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		...
		PartDefinition LeftTopTailSegment9 = LeftTopTailSegment8.addOrReplaceChild("LeftTopTailSegment9",
				CubeListBuilder.create().texOffs(35, 102).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(13, 125).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.7F));

		PartDefinition LeftTopTailSegment10 = LeftTopTailSegment9.addOrReplaceChild("LeftTopTailSegment10",
				CubeListBuilder.create().texOffs(126, 111).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(102, 133).addBox(-0.5F, -1.0F, -0.4F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition LeftTopTailSegment11 = LeftTopTailSegment10.addOrReplaceChild("LeftTopTailSegment11",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r9 = LeftTopTailSegment11.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.2854F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r10 = LeftTopTailSegment11.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.2706F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r11 = LeftTopTailSegment11.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.2706F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r12 = LeftTopTailSegment11.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.2853F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r13 = LeftTopTailSegment11.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.2853F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r14 = LeftTopTailSegment11.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.2854F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r15 = LeftTopTailSegment11.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.537F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition cube_r16 = LeftTopTailSegment11.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.537F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition Tail3 = Tails.addOrReplaceChild("Tail3", CubeListBuilder.create(),
				PartPose.offset(-1.45F, 0.3087F, 0.1863F));

		PartDefinition RightBottomTailSegment = Tail3.addOrReplaceChild("RightBottomTailSegment",
				CubeListBuilder.create(), PartPose.offset(-0.075F, 0.0F, 0.0F));

		PartDefinition RightBottomTailSegment2 = RightBottomTailSegment.addOrReplaceChild("RightBottomTailSegment2",
				CubeListBuilder.create().texOffs(130, 82)
						.addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.25F)).texOffs(116, 21)
						.addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.025F, 0.0F, 0.0F));

		PartDefinition RightBottomTailSegment3 = RightBottomTailSegment2.addOrReplaceChild("RightBottomTailSegment3",
				CubeListBuilder.create().texOffs(86, 97)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(88, 120)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		...
		PartDefinition RightBottomTailSegment4 = RightBottomTailSegment3.addOrReplaceChild("RightBottomTailSegment4",
				CubeListBuilder.create().texOffs(65, 51)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(1, 112)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightBottomTailSegment5 = RightBottomTailSegment4.addOrReplaceChild("RightBottomTailSegment5",
				CubeListBuilder.create().texOffs(112, 111)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(65, 41)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightBottomTailSegment6 = RightBottomTailSegment5.addOrReplaceChild("RightBottomTailSegment6",
				CubeListBuilder.create().texOffs(89, 86)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(45, 40)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightBottomTailSegment7 = RightBottomTailSegment6.addOrReplaceChild("RightBottomTailSegment7",
				CubeListBuilder.create().texOffs(72, 84)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(45, 30)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightBottomTailSegment8 = RightBottomTailSegment7.addOrReplaceChild("RightBottomTailSegment8",
				CubeListBuilder.create().texOffs(45, 20)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(55, 82)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightBottomTailSegment9 = RightBottomTailSegment8.addOrReplaceChild("RightBottomTailSegment9",
				CubeListBuilder.create().texOffs(1, 102)
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(123, 122)
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightBottomTailSegment10 = RightBottomTailSegment9.addOrReplaceChild("RightBottomTailSegment10",
				CubeListBuilder.create().texOffs(102, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.65F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(126, 111).addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition RightBottomTailSegment11 = RightBottomTailSegment10.addOrReplaceChild("RightBottomTailSegment11",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r17 = RightBottomTailSegment11.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.0206F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r18 = RightBottomTailSegment11.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.0206F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r19 = RightBottomTailSegment11.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.0353F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r20 = RightBottomTailSegment11.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.0353F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r21 = RightBottomTailSegment11.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.0354F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r22 = RightBottomTailSegment11.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.0354F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r23 = RightBottomTailSegment11.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.287F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition cube_r24 = RightBottomTailSegment11.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.287F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition Tail4 = Tails.addOrReplaceChild("Tail4", CubeListBuilder.create(),
				PartPose.offset(1.45F, 0.3087F, 0.1863F));

		PartDefinition LeftBottomTailSegment = Tail4.addOrReplaceChild("LeftBottomTailSegment",
				CubeListBuilder.create(), PartPose.offset(0.075F, 0.0F, 0.0F));

		PartDefinition LeftBottomTailSegment2 = LeftBottomTailSegment.addOrReplaceChild("LeftBottomTailSegment2",
				CubeListBuilder.create().texOffs(130, 82).mirror()
						.addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.25F)).mirror(false)
						.texOffs(116, 21).mirror()
						.addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-0.025F, 0.0F, 0.0F));

		PartDefinition LeftBottomTailSegment3 = LeftBottomTailSegment2.addOrReplaceChild("LeftBottomTailSegment3",
				CubeListBuilder.create().texOffs(86, 97).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(88, 120).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.775F));

		PartDefinition LeftBottomTailSegment4 = LeftBottomTailSegment3.addOrReplaceChild("LeftBottomTailSegment4",
				CubeListBuilder.create().texOffs(65, 51).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(1, 112).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition LeftBottomTailSegment5 = LeftBottomTailSegment4.addOrReplaceChild("LeftBottomTailSegment5",
				CubeListBuilder.create().texOffs(112, 111).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(65, 41).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition LeftBottomTailSegment6 = LeftBottomTailSegment5.addOrReplaceChild("LeftBottomTailSegment6",
				CubeListBuilder.create().texOffs(89, 86).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(45, 40).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition LeftBottomTailSegment7 = LeftBottomTailSegment6.addOrReplaceChild("LeftBottomTailSegment7",
				CubeListBuilder.create().texOffs(72, 84).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(45, 30).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.8F));

		PartDefinition LeftBottomTailSegment8 = LeftBottomTailSegment7.addOrReplaceChild("LeftBottomTailSegment8",
				CubeListBuilder.create().texOffs(45, 20).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(55, 82).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));

		PartDefinition LeftBottomTailSegment9 = LeftBottomTailSegment8.addOrReplaceChild("LeftBottomTailSegment9",
				CubeListBuilder.create().texOffs(1, 102).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(123, 122).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.9F));

		PartDefinition LeftBottomTailSegment10 = LeftBottomTailSegment9.addOrReplaceChild("LeftBottomTailSegment10",
				CubeListBuilder.create().texOffs(102, 133)
						.addBox(-0.5F, -1.0F, -0.65F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(126, 111)
						.mirror().addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		...
		PartDefinition cube_r25 = LeftBottomTailSegment11.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.0206F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r26 = LeftBottomTailSegment11.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.0206F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r27 = LeftBottomTailSegment11.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.0353F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r28 = LeftBottomTailSegment11.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.0353F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r29 = LeftBottomTailSegment11.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.0354F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r30 = LeftBottomTailSegment11.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.0354F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r31 = LeftBottomTailSegment11.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.287F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition cube_r32 = LeftBottomTailSegment11.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.287F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition Tail5 = Tails.addOrReplaceChild("Tail5", CubeListBuilder.create(),
				PartPose.offset(-1.45F, 0.3087F, 0.1863F));

		PartDefinition RightTopTailSegment12 = Tail5.addOrReplaceChild("RightTopTailSegment12",
				CubeListBuilder.create(), PartPose.offset(-0.075F, 0.0F, 0.0F));
		...
		PartDefinition RightTopTailSegment22 = RightTopTailSegment21.addOrReplaceChild("RightTopTailSegment22",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r33 = RightTopTailSegment22.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.2854F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r34 = RightTopTailSegment22.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.2706F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r35 = RightTopTailSegment22.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.2706F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r36 = RightTopTailSegment22.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.2853F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r37 = RightTopTailSegment22.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.2853F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r38 = RightTopTailSegment22.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.2854F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r39 = RightTopTailSegment22.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.537F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition cube_r40 = RightTopTailSegment22.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.537F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition Tail6 = Tails.addOrReplaceChild("Tail6", CubeListBuilder.create(),
				PartPose.offset(1.45F, 0.3087F, 0.1863F));

		PartDefinition LeftTopTailSegment12 = Tail6.addOrReplaceChild("LeftTopTailSegment12", CubeListBuilder.create(),
				PartPose.offset(0.075F, 0.0F, 0.0F));
		...
		PartDefinition LeftTopTailSegment16 = LeftTopTailSegment15.addOrReplaceChild("LeftTopTailSegment16",
				CubeListBuilder.create().texOffs(33, 112).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(2, 70).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftTopTailSegment17 = LeftTopTailSegment16.addOrReplaceChild("LeftTopTailSegment17",
				CubeListBuilder.create().texOffs(93, 75).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(24, 51).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftTopTailSegment18 = LeftTopTailSegment17.addOrReplaceChild("LeftTopTailSegment18",
				CubeListBuilder.create().texOffs(36, 91).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(45, 50).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftTopTailSegment19 = LeftTopTailSegment18.addOrReplaceChild("LeftTopTailSegment19",
				CubeListBuilder.create().texOffs(3, 50).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(2, 91).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftTopTailSegment20 = LeftTopTailSegment19.addOrReplaceChild("LeftTopTailSegment20",
				CubeListBuilder.create().texOffs(35, 102).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(13, 125).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftTopTailSegment22 = LeftTopTailSegment21.addOrReplaceChild("LeftTopTailSegment22",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r41 = LeftTopTailSegment22.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.2854F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r42 = LeftTopTailSegment22.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.2706F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r43 = LeftTopTailSegment22.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.2706F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r44 = LeftTopTailSegment22.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.2853F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r45 = LeftTopTailSegment22.addOrReplaceChild("cube_r45",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.2853F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r46 = LeftTopTailSegment22.addOrReplaceChild("cube_r46",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.2854F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r47 = LeftTopTailSegment22.addOrReplaceChild("cube_r47",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.537F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition cube_r48 = LeftTopTailSegment22.addOrReplaceChild("cube_r48",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.537F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition Tail7 = Tails.addOrReplaceChild("Tail7", CubeListBuilder.create(),
				PartPose.offset(-1.45F, 0.3087F, 0.1863F));

		PartDefinition RightBottomTailSegment12 = Tail7.addOrReplaceChild("RightBottomTailSegment12",
				CubeListBuilder.create(), PartPose.offset(-0.075F, 0.0F, 0.0F));
		...
		PartDefinition RightBottomTailSegment22 = RightBottomTailSegment21.addOrReplaceChild("RightBottomTailSegment22",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r49 = RightBottomTailSegment22.addOrReplaceChild("cube_r49",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.0206F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r50 = RightBottomTailSegment22.addOrReplaceChild("cube_r50",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0785F, 4.0206F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r51 = RightBottomTailSegment22.addOrReplaceChild("cube_r51",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.0353F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r52 = RightBottomTailSegment22.addOrReplaceChild("cube_r52",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0382F, 4.0353F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r53 = RightBottomTailSegment22.addOrReplaceChild("cube_r53",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.0354F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r54 = RightBottomTailSegment22.addOrReplaceChild("cube_r54",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.0354F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r55 = RightBottomTailSegment22.addOrReplaceChild("cube_r55",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.287F, -0.4422F, 0.158F, -0.0744F));

		PartDefinition cube_r56 = RightBottomTailSegment22.addOrReplaceChild("cube_r56",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.287F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition Tail8 = Tails.addOrReplaceChild("Tail8", CubeListBuilder.create(),
				PartPose.offset(1.45F, 0.3087F, 0.1863F));

		PartDefinition LeftBottomTailSegment12 = Tail8.addOrReplaceChild("LeftBottomTailSegment12",
				CubeListBuilder.create(), PartPose.offset(0.075F, 0.0F, 0.0F));
		...
		PartDefinition LeftBottomTailSegment16 = LeftBottomTailSegment15.addOrReplaceChild("LeftBottomTailSegment16",
				CubeListBuilder.create().texOffs(112, 111).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(65, 41).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftBottomTailSegment17 = LeftBottomTailSegment16.addOrReplaceChild("LeftBottomTailSegment17",
				CubeListBuilder.create().texOffs(89, 86).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(45, 40).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftBottomTailSegment18 = LeftBottomTailSegment17.addOrReplaceChild("LeftBottomTailSegment18",
				CubeListBuilder.create().texOffs(72, 84).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(45, 30).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftBottomTailSegment19 = LeftBottomTailSegment18.addOrReplaceChild("LeftBottomTailSegment19",
				CubeListBuilder.create().texOffs(45, 20).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(55, 82).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftBottomTailSegment20 = LeftBottomTailSegment19.addOrReplaceChild("LeftBottomTailSegment20",
				CubeListBuilder.create().texOffs(1, 102).mirror()
						.addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(123, 122).mirror()
						.addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition LeftBottomTailSegment22 = LeftBottomTailSegment21.addOrReplaceChild("LeftBottomTailSegment22",
				CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 4.5F));

		PartDefinition cube_r57 = LeftBottomTailSegment22.addOrReplaceChild("cube_r57",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.4959F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.0206F, 0.4472F, -0.2399F, -0.0455F));

		PartDefinition cube_r58 = LeftBottomTailSegment22.addOrReplaceChild("cube_r58",
				CubeListBuilder.create().texOffs(92, 135).addBox(-0.511F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9447F, 1.0785F, 4.0206F, 0.6253F, -0.2244F, -0.0722F));

		PartDefinition cube_r59 = LeftBottomTailSegment22.addOrReplaceChild("cube_r59",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.489F, -0.2762F, -0.5624F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.0353F, 0.6253F, 0.2244F, 0.0722F));

		PartDefinition cube_r60 = LeftBottomTailSegment22.addOrReplaceChild("cube_r60",
				CubeListBuilder.create().texOffs(92, 135).mirror()
						.addBox(-0.5041F, -0.7314F, -0.4769F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.9447F, 1.0382F, 4.0353F, 0.4472F, 0.2399F, 0.0455F));

		PartDefinition cube_r61 = LeftBottomTailSegment22.addOrReplaceChild("cube_r61",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.9987F, 0.0354F, -0.2657F, 0.1685F, -0.0456F));

		PartDefinition cube_r62 = LeftBottomTailSegment22.addOrReplaceChild("cube_r62",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.9987F, 0.0354F, -0.2657F, -0.1685F, 0.0456F));

		PartDefinition cube_r63 = LeftBottomTailSegment22.addOrReplaceChild("cube_r63",
				CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1595F, 0.3072F, 0.287F, -0.4422F, -0.158F, 0.0744F));

		PartDefinition cube_r64 = LeftBottomTailSegment22.addOrReplaceChild("cube_r64",
				CubeListBuilder.create().texOffs(90, 133).mirror()
						.addBox(-0.5F, -1.0F, -0.875F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1595F, 0.3072F, 0.287F, -0.4422F, 0.158F, -0.0744F));
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw,
		...
		if (pEntity instanceof AnimationInterface animationInterface) {
			this.animate(animationInterface.getKanekiIdleEightAnimationState(),
					KanekiRinkakuEightAnimations.KanekiIdleEight, pAgeInTicks);
		}
	}
