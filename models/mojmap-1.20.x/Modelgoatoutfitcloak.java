...
public class Modelgoatoutfitcloak<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goatoutfitcloak"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition dontTouch_r1 = RightLeg.addOrReplaceChild("dontTouch_r1",
				CubeListBuilder.create().texOffs(20, 0).mirror()
						.addBox(-2.275F, -4.4375F, 0.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition dontTouch_r2 = RightLeg.addOrReplaceChild("dontTouch_r2",
				CubeListBuilder.create().texOffs(20, 2).mirror()
						.addBox(0.4312F, -1.2174F, -1.4812F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition dontTouch_r6 = RightLeg.addOrReplaceChild("dontTouch_r6",
				CubeListBuilder.create().texOffs(12, 16).mirror()
						.addBox(0.275F, -4.8375F, 1.6F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition dontTouch_r8 = RightLeg.addOrReplaceChild("dontTouch_r8",
				CubeListBuilder.create().texOffs(12, 6).mirror()
						.addBox(-2.275F, -4.4375F, 0.0F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition dontTouch_r9 = LeftLeg.addOrReplaceChild("dontTouch_r9",
				CubeListBuilder.create().texOffs(0, 6).addBox(-0.0562F, -4.4375F, -2.2625F, 1.0F, 9.0F, 5.0F,
						new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(2.1175F, 4.4844F, -0.2611F, 0.0F, 0.0F, -0.1309F));

		PartDefinition dontTouch_r10 = LeftLeg.addOrReplaceChild("dontTouch_r10",
				CubeListBuilder.create().texOffs(6, 20).addBox(-1.0562F, -4.4375F, 1.5875F, 2.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0054F, 4.3983F, -0.1121F, 0.0F, 0.0F, -0.1309F));

		PartDefinition dontTouch_r11 = LeftLeg.addOrReplaceChild("dontTouch_r11",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.725F, -5.0625F, -2.35F, 5.0F, 1.0F, 5.0F,
						new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(1.4F, 4.5125F, -0.125F, 0.0F, 0.0F, -0.0436F));

		PartDefinition dontTouch_r12 = LeftLeg.addOrReplaceChild("dontTouch_r12",
				CubeListBuilder.create().texOffs(12, 16).addBox(-4.275F, -4.8375F, 1.6F, 4.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.85F, 4.8625F, -0.125F, 0.0F, 0.0F, -0.0436F));

		PartDefinition dontTouch_r13 = LeftLeg.addOrReplaceChild("dontTouch_r13", CubeListBuilder.create()
				.texOffs(20, 2).addBox(-2.4313F, -1.2174F, -1.4812F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 20).addBox(-2.4313F, -0.7174F, -1.4812F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1429F, 0.9924F, -1.1938F, 0.0F, -0.0873F, 0.0F));

		PartDefinition dontTouch_r14 = LeftLeg.addOrReplaceChild("dontTouch_r14",
				CubeListBuilder.create().texOffs(20, 0).addBox(-1.725F, -4.4375F, 0.0F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.6959F, 4.2207F, -2.6427F, 0.0044F, -0.0873F, -0.1309F));

		PartDefinition dontTouch_r15 = LeftLeg.addOrReplaceChild("dontTouch_r15",
				CubeListBuilder.create().texOffs(12, 6).addBox(-1.725F, -4.4375F, 0.0F, 4.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.6959F, 4.5707F, -2.6427F, 0.0044F, -0.0873F, -0.1309F));
