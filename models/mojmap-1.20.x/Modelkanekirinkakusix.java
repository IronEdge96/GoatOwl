...
import net.ironedge.goatowl.KanekiRinkakuSixAnimations;
...
public class Modelkanekirinkakusix<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "kanekirinkakusix"), "main");
	...
	private final ModelPart RightMiddleTailSegment;
	private final ModelPart RightMiddleTailSegment2;
	private final ModelPart RightMiddleTailSegment3;
	private final ModelPart RightMiddleTailSegment4;
	private final ModelPart RightMiddleTailSegment5;
	private final ModelPart RightMiddleTailSegment6;
	private final ModelPart RightMiddleTailSegment7;
	private final ModelPart RightMiddleTailSegment8;
	private final ModelPart RightMiddleTailSegment9;
	private final ModelPart RightMiddleTailSegment10;
	private final ModelPart RightMiddleTailSegment11;
	private final ModelPart Tail6;
	private final ModelPart LeftMiddleTailSegment;
	private final ModelPart LeftMiddleTailSegment2;
	private final ModelPart LeftMiddleTailSegment3;
	private final ModelPart LeftMiddleTailSegment4;
	private final ModelPart LeftMiddleTailSegment5;
	private final ModelPart LeftMiddleTailSegment6;
	private final ModelPart LeftMiddleTailSegment7;
	private final ModelPart LeftMiddleTailSegment8;
	private final ModelPart LeftMiddleTailSegment9;
	private final ModelPart LeftMiddleTailSegment10;
	private final ModelPart LeftMiddleTailSegment11;
	private final ModelPart RightArm;
	private final ModelPart LeftArm;
	private final ModelPart RightLeg;
	private final ModelPart LeftLeg;

	public Modelkanekirinkakusix(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightTopTailSegment2 = RightTopTailSegment.addOrReplaceChild("RightTopTailSegment2",
				CubeListBuilder.create().texOffs(130, 93).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(116, 31).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightTopTailSegment3 = RightTopTailSegment2.addOrReplaceChild("RightTopTailSegment3",
				CubeListBuilder.create().texOffs(99, 0).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(101, 122).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightTopTailSegment4 = RightTopTailSegment3.addOrReplaceChild("RightTopTailSegment4",
				CubeListBuilder.create().texOffs(38, 70).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(15, 114).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightTopTailSegment5 = RightTopTailSegment4.addOrReplaceChild("RightTopTailSegment5",
				CubeListBuilder.create().texOffs(32, 112).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 70).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightTopTailSegment6 = RightTopTailSegment5.addOrReplaceChild("RightTopTailSegment6",
				CubeListBuilder.create().texOffs(91, 75).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(21, 51).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightTopTailSegment7 = RightTopTailSegment6.addOrReplaceChild("RightTopTailSegment7",
				CubeListBuilder.create().texOffs(34, 91).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(42, 50).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightTopTailSegment8 = RightTopTailSegment7.addOrReplaceChild("RightTopTailSegment8",
				CubeListBuilder.create().texOffs(0, 50).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 91).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightTopTailSegment9 = RightTopTailSegment8.addOrReplaceChild("RightTopTailSegment9",
				CubeListBuilder.create().texOffs(34, 102).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(13, 125).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightTopTailSegment10 = RightTopTailSegment9.addOrReplaceChild("RightTopTailSegment10",
				CubeListBuilder.create().texOffs(126, 111).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(102, 133).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightTopTailSegment11 = RightTopTailSegment10.addOrReplaceChild("RightTopTailSegment11", CubeListBuilder.create().texOffs(90, 133).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition LeftTopTailSegment2 = LeftTopTailSegment.addOrReplaceChild("LeftTopTailSegment2",
				CubeListBuilder.create().texOffs(65, 129).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(116, 11).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.025F, 0.0F, 0.0F));
		PartDefinition LeftTopTailSegment3 = LeftTopTailSegment2.addOrReplaceChild("LeftTopTailSegment3",
				CubeListBuilder.create().texOffs(97, 57).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(75, 118).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		PartDefinition LeftTopTailSegment4 = LeftTopTailSegment3.addOrReplaceChild("LeftTopTailSegment4",
				CubeListBuilder.create().texOffs(63, 31).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(96, 109).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftTopTailSegment5 = LeftTopTailSegment4.addOrReplaceChild("LeftTopTailSegment5",
				CubeListBuilder.create().texOffs(108, 78).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(63, 21).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftTopTailSegment6 = LeftTopTailSegment5.addOrReplaceChild("LeftTopTailSegment6",
				CubeListBuilder.create().texOffs(82, 46).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(42, 10).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftTopTailSegment7 = LeftTopTailSegment6.addOrReplaceChild("LeftTopTailSegment7",
				CubeListBuilder.create().texOffs(82, 35).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(42, 0).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition LeftTopTailSegment8 = LeftTopTailSegment7.addOrReplaceChild("LeftTopTailSegment8",
				CubeListBuilder.create().texOffs(21, 41).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(82, 24).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.75F));
		PartDefinition LeftTopTailSegment9 = LeftTopTailSegment8.addOrReplaceChild("LeftTopTailSegment9",
				CubeListBuilder.create().texOffs(99, 40).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(123, 71).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftTopTailSegment10 = LeftTopTailSegment9.addOrReplaceChild("LeftTopTailSegment10",
				CubeListBuilder.create().texOffs(116, 41).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(131, 21).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftTopTailSegment11 = LeftTopTailSegment10.addOrReplaceChild("LeftTopTailSegment11", CubeListBuilder.create().texOffs(131, 11).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 4.5F));
		...
		PartDefinition RightBottomTailSegment2 = RightBottomTailSegment.addOrReplaceChild("RightBottomTailSegment2",
				CubeListBuilder.create().texOffs(130, 82).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(116, 21).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.025F, 0.0F, 0.0F));
		PartDefinition RightBottomTailSegment3 = RightBottomTailSegment2.addOrReplaceChild("RightBottomTailSegment3",
				CubeListBuilder.create().texOffs(85, 97).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(88, 120).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		PartDefinition RightBottomTailSegment4 = RightBottomTailSegment3.addOrReplaceChild("RightBottomTailSegment4",
				CubeListBuilder.create().texOffs(63, 51).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 112).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightBottomTailSegment5 = RightBottomTailSegment4.addOrReplaceChild("RightBottomTailSegment5",
				CubeListBuilder.create().texOffs(111, 111).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(63, 41).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightBottomTailSegment6 = RightBottomTailSegment5.addOrReplaceChild("RightBottomTailSegment6",
				CubeListBuilder.create().texOffs(87, 86).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(42, 40).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightBottomTailSegment7 = RightBottomTailSegment6.addOrReplaceChild("RightBottomTailSegment7",
				CubeListBuilder.create().texOffs(70, 84).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(42, 30).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.8F));
		PartDefinition RightBottomTailSegment8 = RightBottomTailSegment7.addOrReplaceChild("RightBottomTailSegment8",
				CubeListBuilder.create().texOffs(42, 20).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(53, 82).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightBottomTailSegment9 = RightBottomTailSegment8.addOrReplaceChild("RightBottomTailSegment9",
				CubeListBuilder.create().texOffs(0, 102).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(123, 122).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
		...
		PartDefinition RightBottomTailSegment10 = RightBottomTailSegment9.addOrReplaceChild("RightBottomTailSegment10",
				CubeListBuilder.create().texOffs(114, 122).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(83, 131).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightBottomTailSegment11 = RightBottomTailSegment10.addOrReplaceChild("RightBottomTailSegment11", CubeListBuilder.create().texOffs(131, 31).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 4.5F));
		...
		PartDefinition LeftBottomTailSegment2 = LeftBottomTailSegment.addOrReplaceChild("LeftBottomTailSegment2",
				CubeListBuilder.create().texOffs(129, 41).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(116, 1).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.025F, 0.0F, 0.0F));
		PartDefinition LeftBottomTailSegment3 = LeftBottomTailSegment2.addOrReplaceChild("LeftBottomTailSegment3",
				CubeListBuilder.create().texOffs(68, 95).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(117, 100).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		PartDefinition LeftBottomTailSegment4 = LeftBottomTailSegment3.addOrReplaceChild("LeftBottomTailSegment4",
				CubeListBuilder.create().texOffs(63, 11).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(108, 67).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftBottomTailSegment5 = LeftBottomTailSegment4.addOrReplaceChild("LeftBottomTailSegment5",
				CubeListBuilder.create().texOffs(81, 107).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(63, 1).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftBottomTailSegment6 = LeftBottomTailSegment5.addOrReplaceChild("LeftBottomTailSegment6",
				CubeListBuilder.create().texOffs(17, 82).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 40).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftBottomTailSegment7 = LeftBottomTailSegment6.addOrReplaceChild("LeftBottomTailSegment7",
				CubeListBuilder.create().texOffs(82, 13).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(21, 31).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.8F));
		PartDefinition LeftBottomTailSegment8 = LeftBottomTailSegment7.addOrReplaceChild("LeftBottomTailSegment8",
				CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(82, 2).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftBottomTailSegment9 = LeftBottomTailSegment8.addOrReplaceChild("LeftBottomTailSegment9",
				CubeListBuilder.create().texOffs(99, 30).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(123, 60).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.9F));
		PartDefinition LeftBottomTailSegment10 = LeftBottomTailSegment9.addOrReplaceChild("LeftBottomTailSegment10",
				CubeListBuilder.create().texOffs(114, 60).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(131, 0).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftBottomTailSegment11 = LeftBottomTailSegment10.addOrReplaceChild("LeftBottomTailSegment11", CubeListBuilder.create().texOffs(76, 129).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 4.5F));
		...
		PartDefinition RightMiddleTailSegment2 = RightMiddleTailSegment.addOrReplaceChild("RightMiddleTailSegment2",
				CubeListBuilder.create().texOffs(54, 127).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(114, 50).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.025F, 0.0F, 0.0F));
		PartDefinition RightMiddleTailSegment3 = RightMiddleTailSegment2.addOrReplaceChild("RightMiddleTailSegment3",
				CubeListBuilder.create().texOffs(51, 93).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(117, 89).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		PartDefinition RightMiddleTailSegment4 = RightMiddleTailSegment3.addOrReplaceChild("RightMiddleTailSegment4",
				CubeListBuilder.create().texOffs(61, 61).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(66, 105).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment5 = RightMiddleTailSegment4.addOrReplaceChild("RightMiddleTailSegment5",
				CubeListBuilder.create().texOffs(51, 103).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(19, 61).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment6 = RightMiddleTailSegment5.addOrReplaceChild("RightMiddleTailSegment6",
				CubeListBuilder.create().texOffs(80, 62).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(21, 21).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment7 = RightMiddleTailSegment6.addOrReplaceChild("RightMiddleTailSegment7",
				CubeListBuilder.create().texOffs(36, 80).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(21, 11).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.75F));
		PartDefinition RightMiddleTailSegment8 = RightMiddleTailSegment7.addOrReplaceChild("RightMiddleTailSegment8",
				CubeListBuilder.create().texOffs(21, 1).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 80).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment9 = RightMiddleTailSegment8.addOrReplaceChild("RightMiddleTailSegment9",
				CubeListBuilder.create().texOffs(99, 20).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(30, 123).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment10 = RightMiddleTailSegment9.addOrReplaceChild("RightMiddleTailSegment10",
				CubeListBuilder.create().texOffs(104, 89).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(129, 52).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition RightMiddleTailSegment11 = RightMiddleTailSegment10.addOrReplaceChild("RightMiddleTailSegment11", CubeListBuilder.create().texOffs(26, 125).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 4.5F));
		...
		PartDefinition LeftMiddleTailSegment2 = LeftMiddleTailSegment.addOrReplaceChild("LeftMiddleTailSegment2",
				CubeListBuilder.create().texOffs(43, 125).addBox(-0.5F, -0.5F, -0.475F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(47, 114).addBox(-1.5F, -0.5F, 0.025F, 3.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(-0.025F, 0.0F, 0.0F));
		PartDefinition LeftMiddleTailSegment3 = LeftMiddleTailSegment2.addOrReplaceChild("LeftMiddleTailSegment3",
				CubeListBuilder.create().texOffs(17, 93).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(62, 116).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.775F));
		PartDefinition LeftMiddleTailSegment4 = LeftMiddleTailSegment3.addOrReplaceChild("LeftMiddleTailSegment4",
				CubeListBuilder.create().texOffs(42, 60).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(17, 103).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment5 = LeftMiddleTailSegment4.addOrReplaceChild("LeftMiddleTailSegment5",
				CubeListBuilder.create().texOffs(102, 98).addBox(-1.5F, -1.0F, -0.5F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 60).addBox(-2.5F, -0.5F, -0.25F, 5.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment6 = LeftMiddleTailSegment5.addOrReplaceChild("LeftMiddleTailSegment6",
				CubeListBuilder.create().texOffs(74, 73).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 20).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment7 = LeftMiddleTailSegment6.addOrReplaceChild("LeftMiddleTailSegment7",
				CubeListBuilder.create().texOffs(57, 71).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 10).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.75F));
		PartDefinition LeftMiddleTailSegment8 = LeftMiddleTailSegment7.addOrReplaceChild("LeftMiddleTailSegment8",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -0.5F, -0.25F, 6.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(19, 71).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment9 = LeftMiddleTailSegment8.addOrReplaceChild("LeftMiddleTailSegment9",
				CubeListBuilder.create().texOffs(99, 10).addBox(-2.0F, -0.5F, -0.25F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.69F)).texOffs(0, 123).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment10 = LeftMiddleTailSegment9.addOrReplaceChild("LeftMiddleTailSegment10",
				CubeListBuilder.create().texOffs(101, 68).addBox(-1.5F, -0.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.69F)).texOffs(108, 50).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 8.5F));
		PartDefinition LeftMiddleTailSegment11 = LeftMiddleTailSegment10.addOrReplaceChild("LeftMiddleTailSegment11", CubeListBuilder.create().texOffs(38, 61).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.69F)),
				PartPose.offset(0.0F, 0.0F, 4.5F));
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		if (pEntity instanceof AnimationInterface animationInterface) {
			this.animate(animationInterface.getKanekiIdleSixAnimationState(), KanekiRinkakuSixAnimations.KanekiIdleSix, pAgeInTicks);
		}
	}
