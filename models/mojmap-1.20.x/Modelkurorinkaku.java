...
public class Modelkurorinkaku<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "kurorinkaku"), "main");
	...
	private final ModelPart RightTailSegment10;
	private final ModelPart RightTailSegment11;
