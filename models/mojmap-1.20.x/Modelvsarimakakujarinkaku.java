...
public class Modelvsarimakakujarinkaku<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "vsarimakakujarinkaku"), "main");
	...
	private final ModelPart RightTopTailBlade;
	...
	private final ModelPart LeftTopTailBlade;
	...
	private final ModelPart RightBottomTailBlade;
	...
	private final ModelPart LeftBottomTailBlade;
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		if (pEntity instanceof AnimationInterface animationInterface) {
			this.animate(animationInterface.getVSArimaKakujaRinkakuIdleAnimationState(), VSArimaKakujaAnimations.VSArimaKakujaRinkakuIdle, pAgeInTicks);
		}
	}
