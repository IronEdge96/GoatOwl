...
public class Modelnorooutfitcloak<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "norooutfitcloak"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(22, 16)
				...
				.addBox(-3.6366F, 8.6986F, -2.5746F, 1.0F, 3.0F, 5.0F, new CubeDeformation(-0.1F)).mirror(false),
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(22, 16)
				...
				.addBox(2.6366F, 8.6986F, -2.5996F, 1.0F, 3.0F, 5.0F, new CubeDeformation(-0.1F)),
				PartPose.offset(2.0F, 12.0F, 0.0F));
